...
## Unused rn
## Uncomment to put the PS_SYMBOL on the next line
# POWERLINE_NEWLINE=1
...
__powerline() {    
    ...
    readonly BASE_BG_COLOR=49
    readonly BASE_BG_EXTRA=""
    readonly BASE_FG='1;32'
    readonly BASE_STR="\u"

    readonly CWD_BG_COLOR=49
    readonly CWD_BG_EXTRA=""
    readonly CWD_FG='1;34'

    readonly GIT_BG_COLOR=29
    readonly GIT_BG_EXTRA=''
    readonly GIT_FG='1;37'
    readonly GIT_FG_MODIFIED='1;31'
    readonly SYMBOL_GIT_MODIFIED='~'

    readonly PS_ZERO_BG_COLOR=49
    readonly PS_ERR_BG_COLOR=49
    readonly PS_ZERO_BG_EXTRA=''
    readonly PS_ERR_BG_EXTRA=''
    readonly PS_ZERO_FG='1;32'
    readonly PS_ERR_FG='1;31'
    ...
    ps1() {
        ...
        # Generate PS1
        PS1=""
        __block "[$BASE_STR]:" "$BASE_BG_COLOR" "$BASE_FG" 1
        __block "$cwd" "$CWD_BG_COLOR" "$CWD_FG" 1
        __block "$git" "$GIT_BG_COLOR" "$git_style" 0 1
        __block "\n $PS_SYMBOL" "${ps_style[0]}" "${ps_style[1]}" 0
